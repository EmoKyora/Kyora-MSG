...
const TopDownShark = ({ glowColor, fillCol = "#FFFFFF", delay = 0 }) => {
  ...
  // พิกัดหางงอไปทางขวา (ปรับลำตัวให้หนาและสมส่วนขึ้น)
  const tailRight =
    "M 50,2 C 60,2 68,18 68,40 C 78,50 84,65 82,75 C 76,70 70,62 64,60 C 64,75 64,85 64,95 C 66,98 68,101 68,105 C 64,107 64,112 66,120 C 80,130 96,140 98,148 C 84,140 74,136 68,136 C 55,136 45,142 38,148 C 45,138 52,130 56,120 C 52,112 52,107 50,105 C 52,101 54,98 52,95 C 46,85 44,75 40,60 C 32,62 24,70 18,75 C 16,65 22,50 32,40 C 32,18 40,2 50,2 Z";

  // พิกัดหางงอไปทางซ้าย (ปรับลำตัวให้หนาและสมส่วนขึ้น)
  const tailLeft =
    "M 50,2 C 60,2 68,18 68,40 C 78,50 84,65 82,75 C 76,70 70,62 64,60 C 60,75 56,85 54,95 C 52,98 52,101 54,105 C 48,107 48,112 44,120 C 52,130 60,138 66,148 C 58,142 46,136 34,136 C 26,136 14,140 2,148 C 6,140 22,130 36,120 C 40,112 40,107 36,105 C 36,101 38,98 42,95 C 40,85 38,75 36,60 C 32,62 24,70 18,75 C 16,65 22,50 32,40 C 32,18 40,2 50,2 Z";
