...
const TopDownShark = ({ glowColor, fillCol = "#FFFFFF", delay = 0 }) => {
  ...
  // พิกัดหางงอไปทางขวา (ปรับครีบคู่หน้าให้เรียวขึ้น และเลื่อนลงมากลางลำตัว)
  const tailRight =
    "M 50,2 C 56,2 62,20 62,40 C 72,50 78,65 76,75 C 70,70 64,62 58,60 C 58,75 59,85 60,95 C 64,98 66,101 66,105 C 62,107 62,112 64,120 C 80,130 96,140 98,148 C 84,140 74,136 68,136 C 55,136 45,142 38,148 C 45,138 52,130 58,120 C 54,112 54,107 50,105 C 52,101 53,98 52,95 C 41,85 42,75 42,60 C 36,62 30,70 24,75 C 22,65 28,50 38,40 C 38,20 44,2 50,2 Z";

  // พิกัดหางงอไปทางซ้าย (ปรับครีบคู่หน้าให้เรียวขึ้น และเลื่อนลงมากลางลำตัวเช่นเดียวกัน)
  const tailLeft =
    "M 50,2 C 56,2 62,20 62,40 C 72,50 78,65 76,75 C 70,70 64,62 58,60 C 54,75 51,85 48,95 C 47,98 48,101 50,105 C 46,107 46,112 42,120 C 48,130 55,138 62,148 C 55,142 45,136 32,136 C 26,136 16,140 2,148 C 4,140 20,130 36,120 C 38,112 38,107 34,105 C 34,101 36,98 40,95 C 41,85 42,75 42,60 C 36,62 30,70 24,75 C 22,65 28,50 38,40 C 38,20 44,2 50,2 Z";
